  ...
  return (
    <div className="space-y-8 pb-8 bg-white">
      ...
      <div className="bg-white border-b border-slate-200 pb-6 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        ...
        <div className="bg-emerald-50 border border-emerald-200 text-emerald-900 px-3 py-1.5 rounded-md text-xs flex items-center gap-2 font-semibold shrink-0">
      ...
      {toastMessage && (
        <div
          className={`p-4 rounded-md border flex justify-between items-center text-xs font-semibold ${
            ...
            <form onSubmit={handleRegisterAndCheckIn} className="space-y-3">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-white border border-slate-300 rounded-md px-3 py-2 text-xs font-medium text-slate-800 focus:ring-1 focus:ring-slate-900 focus:outline-none"
                />
              </div>
              ...
              {patientQueue.map((pt) => {
                ...
                return (
                  <div
                    ...
                    className={`p-3.5 rounded-md border transition cursor-pointer flex flex-col space-y-2 ${
                      isSelected
                  ...
                  >
                    ...
                    {/* Symptoms Chips */}
                    <div className="flex flex-wrap items-center justify-between gap-1 pt-1.5 border-t border-slate-100">
                      <div className="flex flex-wrap gap-1">
                        {pt.symptoms.map((s, i) => (
                          <span key={i} className="text-[10px] bg-slate-100 text-slate-700 border border-slate-200 px-1.5 py-0.5 rounded-sm font-mono">
                            {s}
                          </span>
                        ))}
                      </div>
                      <span className="text-[10px] text-slate-500 font-mono">{pt.checkin_time}</span>
                    </div>
                  </div>
                );
              })}
          ...
          <div className="bg-white rounded-md border border-slate-200 p-6 space-y-5">
            ...
            {selectedPatient ? (
              <div className="bg-slate-900 text-white rounded-md p-4 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
                <div>
                  ...
                  <h3 className="text-lg font-extrabold text-white m-0 mt-1 tracking-tight">
                  ...
                  <p className="text-xs text-slate-300 m-0 mt-0.5">
                    ...
                    <span className="text-slate-200">{selectedPatient.symptoms.join(', ')}</span>
                  </p>
                </div>
            ...
            <div className="space-y-1.5">
              ...
              <textarea
                ...
                className="w-full bg-white border border-slate-300 rounded-md p-2.5 text-xs text-slate-800 focus:ring-1 focus:ring-slate-900 focus:outline-none"
              />
            </div>
                      ...
                      <tr key={idx} className="hover:bg-slate-50 transition-colors">
                        <td className="p-3">
                          ...
                          <input
                            ...
                            className="w-full mt-1 bg-white border border-slate-300 rounded-md px-2 py-1 text-[11px] text-slate-700 focus:ring-1 focus:ring-slate-900 focus:outline-none"
                          />
                        </td>
                        <td className="p-3">
                          <div className="flex items-center gap-1">
                            <input
                              ...
                              className="w-16 bg-white border border-slate-300 rounded-md px-2 py-1 text-xs font-mono font-bold text-slate-900 focus:ring-1 focus:ring-slate-900 focus:outline-none text-center"
                            />
